...
<div class="text_cell_render border-box-sizing rendered_html">
<p>There have been some interesting discussions happening lately surrounding the creation of XKCD-style plots in
matplotlib.  As near as I can tell, this started with a thread on a
...
matplotlib until version 1.3.  In the mean-time, I wanted a way to play around with
...
<span class="k">if</span> <span class="ow">not</span> <span class="n">os</span><span class="o">.</span><span class="n">path</span><span class="o">.</span><span class="n">exists</span><span class="p">(</span><span class="s">&#39;Humor-Sans.ttf&#39;</span><span class="p">):</span>
    <span class="n">fhandle</span> <span class="o">=</span> <span class="n">urllib2</span><span class="o">.</span><span class="n">open</span><span class="p">(</span><span class="s">&#39;http://antiyawn.com/uploads/Humor-Sans.ttf&#39;</span><span class="p">)</span>
...
<pre class="ipynb">&lt;matplotlib.axes.AxesSubplot at 0x3282f50&gt;</pre>
</div>
</div>
<div class="hbox output_area">
<div class="prompt output_prompt"></div>
...
<span class="n">Image</span><span class="p">(</span><span class="s">&#39;http://imgs.xkcd.com/comics/front_door.png&#39;</span><span class="p">)</span>
</pre></div>
...
<span class="n">ax</span><span class="o">.</span><span class="n">text</span><span class="p">(</span><span class="mf">0.9</span><span class="p">,</span> <span class="mf">0.4</span><span class="p">,</span> <span class="s">&quot;embarassment&quot;</span><span class="p">)</span>
...
<div class="output_subarea output_pyout">
<pre class="ipynb">&lt;matplotlib.axes.AxesSubplot at 0x4563d50&gt;</pre>
</div>
</div>
<div class="hbox output_area">
<div class="prompt output_prompt"></div>
<div class="output_subarea output_display_data">
<img src="data:image/png;base64,
"></img>
</div>
</div>
</div>
